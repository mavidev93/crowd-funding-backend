...
*/
    ...
    //Events
    event Fund(address indexed from, address indexed campaignOwner,string indexed campaignHash);
        ...
        campaignShouldExist(_hash)
    {
        ...
        emit Fund(msg.sender,hashToCampaign[_hash].campaignOwner,hashToCampaign[_hash].campaignOwner);

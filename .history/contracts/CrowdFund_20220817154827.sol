...
*/
    ...
    //Events
    event Fund(address indexed from, address indexed campaignOwner,uint256 indexed id);
    event Test(address indexed from, uint256 indexed id);
        ...
        campaignShouldExist(_hash)
    {
        ...
        hashToCampaign[_hash].totalAmountFunded =
            ...
            msg.value;
        console.log(_hash);
        emit Fund(msg.sender,hashToCampaign[_hash].campaignOwner,hashToCampaign[_hash].id);
    ...
    function test() public {
        emit Test(msg.sender,_campaignIds);
    }

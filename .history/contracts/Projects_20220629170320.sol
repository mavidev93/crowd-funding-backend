git//SPDX-License-Identifier: Unlicense
...
contract Projects {
    ...
    function getProjectFundedAmount(bytes32 _projectHashId) public view returns(uint256){
        return s_projectHashedIdToProject[_projectHashId].fundedAmount;
    }

    function getNumberOfFunders(bytes32 _projectHashId) public view returns(uint256){
        return s_projectHashedIdToFunders
    }
}

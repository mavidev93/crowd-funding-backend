...
contract Project {
    ...
    constructor(uint256 _minimumFundAmount) {
        i_owner = msg.sender;
    ...
    function fundProject(bytes32 _projectHashId) public payable {
        ...
        s_projectHashedIdToFunders[_projectHashId].push(
    ...
    function getProjectFundedAmount(bytes32 _projectHashId)
        public
        view
        returns (uint256)
    {
    ...
    function getNumberOfFunders(bytes32 _projectHashId)
        public
        view
        returns (uint256)
    {

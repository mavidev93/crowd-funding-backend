...
!developmentChains.includes(network.name)?describe.skip:describe("CrowdFund unit test",()=>{
    ...
    describe("constructor",()=>{
        it("initialize the crowdFund correctly",async()=>{
            const owner = await crowdFund.owner()
            expect(deployer.address===owner,"deployer address and owner address are equal")
        })
    })
